...
def main(input,output):
    ...
    '''
    output.write('TransID\tAves\tReptilia\tMammalia\tAmphibia\tOther\n')
    Dict = {}
    for line in input:
...
#        if float(line[2]) < 70 or float(line[13]) > 0.0000000001: continue
        ...
        if Tax[3] == 'Aves' : Dict[line[0]][0] = '1'
        elif Tax[4] == 'Squamata' or Tax[4] == 'Crocodylia' or Tax[4] == 'Testudines': Dict[line[0]][1] = '1'
        elif Tax[3] == 'Mammalia': Dict[line[0]][2] = '1'
        elif Tax[3] == 'Amphibia': Dict[line[0]][3] = '1'
        else: Dict[line[0]][4] = '1'
